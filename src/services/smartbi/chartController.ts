...
/** genChartByAiAsync POST /api/chart/upload/async */
export async function genChartByAiAsyncUsingPost(
  ...
  return request<API.BaseResponseBiResponse_>('/api/chart/upload/async', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** genChartByAiAsyncMq POST /api/chart/upload/async/mq */
export async function genChartByAiAsyncMqUsingPost(
  ...
  return request<API.BaseResponseBiResponse_>('/api/chart/upload/async/mq', {
    method: 'POST',
    params: {
      ...params,
    },
